...
: ${AMENT_CURRENT_PREFIX:="/root/rm_ws/install/chat"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/chat/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/chat/environment/path.sh"
